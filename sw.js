...
const ASSETS = [
    ...
    './assets/js/core/json_extract.js',
    './assets/js/core/ai_search.js',
    './assets/js/core/swipe_row.js',
    './assets/js/panels/search_panel.js',
    './assets/js/panels/library_panel.js',
    './assets/js/panels/setlist_panel.js',
    './assets/js/panels/key_panel.js',
    './assets/js/sheets/song_sheet.js',
    './assets/js/sheets/edit_sheet.js',
    './assets/js/sheets/settings_sheet.js',
    './assets/js/sheets/pickpl_sheet.js',
    './assets/js/sheets/newpl_sheet.js',
    './assets/js/app.js',
